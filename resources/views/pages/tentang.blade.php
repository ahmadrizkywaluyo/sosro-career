...
<x-app-layout>
    ...
    {{-- SECTION: HERO ABOUT --}}
    <section class="py-24 bg-gradient-to-b from-red-50 to-white">
        <div class="max-w-5xl mx-auto px-6 text-center">
            <h1 class="text-4xl md:text-5xl font-bold text-red-700 mb-6">
            ...
            <p class="text-gray-700 leading-relaxed text-lg mb-6">
                ...
                menjadi perusahaan yang inovatif dan berorientasi pada kualitas.
            </p>

            <p class="text-gray-700 leading-relaxed text-lg">
                Melalui platform e-recruitment ini, kami membuka kesempatan bagi talenta muda
                untuk tumbuh dan berkarier bersama perusahaan yang menjunjung nilai integritas,
                profesionalitas, dan kerja sama.
            </p>
        </div>
    </section>
