<x-app-layout>
    ...
    <section class="relative py-28 bg-gradient-to-r from-red-700 to-red-500 text-white overflow-hidden">
        <div class="absolute inset-0 opacity-20 bg-[url('https://images.unsplash.com/photo-1522202176988-66273c2fd55f')] bg-cover bg-center"></div>

        <div class="max-w-5xl mx-auto px-6 relative z-10 text-center">
            <h1 class="text-4xl md:text-5xl font-bold mb-4">
                Program Pengembangan Karier di Sosro
            </h1>
            <p class="text-lg md:text-xl text-red-100 max-w-3xl mx-auto leading-relaxed">
                Kami menyediakan berbagai jalur pengembangan karier untuk membantu kamu tumbuh,
                belajar, dan menjadi bagian dari masa depan Sosro.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <p class="text-gray-700 text-lg leading-relaxed">
                "Sosro berkomitmen untuk menciptakan lingkungan kerja yang mendukung pelatihan,
                pertumbuhan karier, dan kesempatan untuk berkontribusi secara maksimal.
                Program-program di bawah ini dirancang untuk membantu talenta terbaik berkembang
